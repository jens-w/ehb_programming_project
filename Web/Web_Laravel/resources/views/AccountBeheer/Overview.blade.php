...
<div class="row">
    ...
    <div class="col-sm-4 col-md-2">
        <ul class="list-unstyled">
            <li class="active"><i class="far fa-user"></i><a data-toggle="tab" href="#accountGegevens" onclick="RemoveActive();">Account
                    Gegevens</a></li>
            <li><i class="fas fa-book-open"></i><a data-toggle="tab" href="#Vakken" onclick="RemoveActive();">Vakken</a></li>
        </ul>
    </div>
    <!-- content -->
